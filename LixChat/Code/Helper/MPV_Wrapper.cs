...
namespace LX29_Twitch.Extras
{
    ...
    {
        public const string MPVPATH = LX29_TwitchChat.Settings.pluginDir + "\\MPV\\mpv.exe";
        ...
        public bool Start(string Title, string fileName, int volume, int cache, IntPtr handle, int cacheSecs = 10, System.Drawing.Rectangle rect = new System.Drawing.Rectangle())
        {
            ...
            process.StartInfo.WorkingDirectory = LX29_TwitchChat.Settings.pluginDir + "\\MPV";
            ...
            while (true)
            {
                ...
                if (DateTime.Now.Subtract(timeOut).TotalSeconds > 5 ||
